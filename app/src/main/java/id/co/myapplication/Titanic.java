...
public class Titanic extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_romance, container, false);

        Titanic = view.findViewById(R.id.titanic);

        Titanic.setOnClickListener(v -> playVideo("titanic"));
    ...
    public static Titanic newInstance(String param1, String param2) {
        Titanic fragment = new Titanic();

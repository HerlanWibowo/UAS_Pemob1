...
public class MyName extends Fragment {

    private ImageView MyName;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_action, container, false);

        MyName = view.findViewById(R.id.myname);

        MyName.setOnClickListener(v -> playVideo("myname"));
    ...
    public static MyName newInstance(String param1, String param2) {
        MyName fragment = new MyName();
